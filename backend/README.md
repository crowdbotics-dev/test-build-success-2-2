...
## Project Structure
    ...
    ├── test_build_success_2_2  # Django project configurations
...
1. Clone this repo and `cd test_build_success_2_2`
...
2. Clone this repo and `cd test_build_success_2_2`
